//-----------------------------------------------------------------------
// <copyright file="NetworkUtility.cs" company="SysTek">
//     Copyright (c) SysTek. All rights reserved.
// </copyright>
// <author>Hule</author>
//-----------------------------------------------------------------------

namespace SysViewHyTurb.Driver.Utility
{
    using System;
    ...
    public static class NetworkUtility
    {
        ...
        /// <summary>
        /// Converts two unsigned integer 16 values into a IEEE 32 floating point format
        /// </summary>
        /// <param name="highOrderValue">High order unsigned short value</param>
        /// <param name="lowOrderValue">Low order unsigned short value</param>
        ...
        public static float GetSingle(ushort highOrderValue, ushort lowOrderValue)
        {
            ...
            byte[] bytLow = BitConverter.GetBytes(lowOrderValue);
            byte[] bytHigh = BitConverter.GetBytes(highOrderValue);
            bytArray[0] = bytLow[0];
            bytArray[1] = bytLow[1];
            bytArray[2] = bytHigh[0];
            bytArray[3] = bytHigh[1];
            return BitConverter.ToSingle(bytArray, 0);
        }

        /// <summary>
        /// Converts two Unsigned Integer 16 values into a Unsigned Integer 32
        /// </summary>
        /// <param name="highOrderValue">High order value</param>
        /// <param name="lowOrderValue">Low order value</param>
        ...
        public static uint GetUInt32(ushort highOrderValue, ushort lowOrderValue)
        {
            ...
            bytArray[2] = bytHigh[0];
            bytArray[3] = bytHigh[1];
            return BitConverter.ToUInt32(bytArray, 0);
        }
        ...
        /// <summary>
        /// Converts an array of Unsigned Integer 16 to an ASCII byte array
        /// </summary>
        /// <param name="numbers">The unsigned short array</param>
        /// <returns>An array of ASCII byte values</returns>
        ...
        /// <summary>
        /// Converts a network order byte array to an array of Unsigned Integer 16 values in host order
        /// </summary>
        /// <param name="networkBytes">The network order byte array</param>
        /// <returns>The host order unsigned short array</returns>
        ...
        public static ushort[] HexToUshorts(string hex)
        {
            ...
            ushort[] ushorts = new ushort[hex.Length/4];
            for (int i = 0; i < ushorts.Length; i++)
            {
                ushorts[i] = Convert.ToUInt16(hex.Substring(i * 4, 4), 16);
            }
            return ushorts;
        }
        ...
        /// Calculate XOR Check.
        /// </summary>
        /// <param name="data">The data used in XOR</param>
